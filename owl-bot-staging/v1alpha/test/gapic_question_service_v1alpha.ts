...
describe('v1alpha.QuestionServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = questionserviceModule.v1alpha.QuestionServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = questionserviceModule.v1alpha.QuestionServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getQuestion', () => {
        it('invokes getQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetQuestionRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getQuestion as SinonStub)
        ...
        it('invokes getQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.getQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getQuestion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataqna.v1alpha.IQuestion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getQuestion with error', async () => {
            ...
            client.innerApiCalls.getQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('createQuestion', () => {
        it('invokes createQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateQuestionRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.createQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('executeQuestion', () => {
        it('invokes executeQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExecuteQuestionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataqna.v1alpha.Question()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.executeQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.executeQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes executeQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.executeQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes executeQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.executeQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('getUserFeedback', () => {
        it('invokes getUserFeedback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetUserFeedbackRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getUserFeedback as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getUserFeedback as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getUserFeedback without error using callback', async () => {
            ...
            client.innerApiCalls.getUserFeedback = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUserFeedback(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataqna.v1alpha.IUserFeedback|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getUserFeedback with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getUserFeedback = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateUserFeedback', () => {
        it('invokes updateUserFeedback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateUserFeedbackRequest', ['userFeedback', 'name']);
            request.userFeedback.name = defaultValue1;
            const expectedHeaderRequestParams = `user_feedback.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataqna.v1alpha.UserFeedback()
            );
            client.innerApiCalls.updateUserFeedback = stubSimpleCall(expectedResponse);
            const [response] = await client.updateUserFeedback(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateUserFeedback as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateUserFeedback as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateUserFeedback without error using callback', async () => {
            ...
            client.innerApiCalls.updateUserFeedback = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateUserFeedback with error', async () => {
            ...
            const expectedHeaderRequestParams = `user_feedback.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateUserFeedback = stubSimpleCall(undefined, expectedError);
