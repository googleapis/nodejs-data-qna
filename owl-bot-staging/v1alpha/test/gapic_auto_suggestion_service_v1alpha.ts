...
describe('v1alpha.AutoSuggestionServiceClient', () => {
    ...
    describe('suggestQueries', () => {
        it('invokes suggestQueries without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataqna.v1alpha.SuggestQueriesResponse());
            ...
            assert((client.innerApiCalls.suggestQueries as SinonStub)
